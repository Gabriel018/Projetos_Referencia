...
namespace Prover_Web.Controllers
{
    public class VendedorsController : Controller
    {
        private readonly AppDBContext _context;

        public VendedorsController(AppDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedor != null ? 
                          ...
                          Problem("Entity set 'AppDBContext.Vendedor'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf,Telefone,Descricao,Categoria")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf,Telefone,Descricao,Categoria")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDBContext.Vendedor'  is null.");
            }
            var vendedor = await _context.Vendedor.FindAsync(id);
            if (vendedor != null)
            {
