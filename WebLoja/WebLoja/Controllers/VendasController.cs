...
namespace WebLoja.Controllers
{
    public class VendasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Vendas.Include(v => v.Produto).Include(v => v.Vendedor);
        ...
        public async Task<IActionResult> Create([Bind("Id,VendedorId,ProdutoId,Quantidade,DataVenda")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VendedorId,ProdutoId,Quantidade,DataVenda")] Venda venda)
        {
            if (id != venda.Id)
            {
                return NotFound();
