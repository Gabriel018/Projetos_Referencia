...
namespace WebLoja.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Endereço,Telefone")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Endereço,Telefone")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
